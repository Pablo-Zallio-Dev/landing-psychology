        ...
        <section className=" mx-3 p-5 lg:h-full bg-white shadow-md rounded-md ">
          ...
          >
            ...
            <div className=" w-full sm:col-span-2  flex flex-col gap-1 ">
              <label htmlFor="formNotas" className=" font-medium text-xs  ">
                Mensaje*
              </label>
              <textarea
                required
            ...
            <section className=" p-3 bg-yellow-50 border border-yellow-200 rounded-md">
              <p className=" text-xs text-yellow-900 ">
                <b>Confidencialidad:</b> Toda la información compartida es
                estrictamente confidencial y protegida bajo el secreto
                profesional.
              </p>
            </section>
